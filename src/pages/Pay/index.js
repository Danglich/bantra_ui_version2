...
import ItemOrderForPay from '../../components/ItemOrderForPay';
...
function Pay() {
    ...
    const { orderItems, totalPrice } = useContext(OrderContext);
                    ...
                    <div className="mr-[18px] max-md:mx-0 ">
                        ...
                        <div className="mt-[20px]">
                            ...
                            <div className="flex items-center justify-between mt-[8px]">
                                ...
                                <p className="text-[15px] font-[600]">
                                    {numeral(shippingPrice * 1000).format(
                                        '0,0',
                                    )}
                                    đ
                                </p>
